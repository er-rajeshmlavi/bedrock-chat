...
@patch('app.agents.tools.summary.boto3.client')
def test_successful_summary_generation(mock_boto_client):
...
@patch('app.agents.tools.summary.boto3.client')
def test_bedrock_client_error_handling(mock_boto_client):
